...
const { createOrder, getOrders,progress, deliverOrder, accpetOrder, getFreelancerOrders, leaveFeedback } = require("../controllers/orderController");
...
router.patch('/:id/accept',authMiddleware, accpetOrder )
